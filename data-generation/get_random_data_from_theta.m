function [frames, beta_init, thetas_init] = get_random_data_from_theta(beta_true, thetas_true, settings)
...
beta_init = beta_true + settings.beta_bias + settings.beta_noise_std * randn(B, 1);
