...
for beta_index = beta_indices
    ...
    %% Display history
    display_history_with_variance(means, standard_deviations, importance_means, importance_standard_deviations, beta_true(beta_index), ylimit, settings, N, frame_centrainty, 'sticks_finger', beta_indices, beta_index);
