function [F, J, H] = sticks_finger_eg_single(x, segments0, joints, data_points, jacobian_type)
...
[f, j, h] = jacobian_shape_pose_cpp_wrapper(betas, thetas, segments, joints, model_points, data_points, segment_indices, jacobian_type);
F = f;
J = j;
H = h;
